...
class Stories(models.Model):
    user = models.ForeignKey('auth.User', on_delete=models.CASCADE, related_name='user_story')
    posted = models.DateTimeField(auto_now_add=True)
    image = models.FileField(upload_to='post/media/stories')
    readers = models.ManyToManyField('auth.User',related_name='story_readers')
